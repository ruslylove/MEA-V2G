...
class TestMeaSection1:
    ...
    @pytest.fixture
    def auth(self):
        return self.PreemptiveDigestAuth(self.USERNAME, self.PASSWORD, realm="EV")
    ...
    def get_packet_log(self, timeout=5):
        try:
    ...
    def test_1_1_boot_notification(self):
        ...
        while time.time() - start_time < 15:
            log = self.get_packet_log(timeout=1)
            if log:
                print(log)
    ...
    def test_1_2_status_notification(self):
        """
        1.2 StatusNotification
    ...
    def test_1_3_trigger_boot(self, evse_simulation):
        """
        1.3 TriggerMessage (BootNotification)
        ...
        self.inject_csms_command(evse_simulation, "TriggerMessage", {"requestedMessage": "BootNotification"})
    ...
    def test_1_4_boot_notification_response(self):
        """
    ...
    def test_1_5_trigger_status(self, evse_simulation):
        """
        1.5 TriggerMessage (StatusNotification)
        """
        print("\n--- TEST CASE: 1.5 TriggerMessage (StatusNotification) ---")
        self.inject_csms_command(evse_simulation, "TriggerMessage", {"requestedMessage": "StatusNotification"})
    ...
    def test_1_6_status_notification_response(self):
        """
    ...
    def test_1_7_trigger_meter_values(self, evse_simulation):
        """
        1.7 TriggerMessage (MeterValues)
        """
        print("\n--- TEST CASE: 1.7 TriggerMessage (MeterValues) ---")
        self.inject_csms_command(evse_simulation, "TriggerMessage", {"requestedMessage": "MeterValues"})


    # 1.8 MeterValues (Response to Trigger)
    def test_1_8_meter_values_response(self):
        """
        1.8 MeterValues
        """
    ...
    def test_1_9_get_configuration(self, auth, headers):
        """
        1.9 GetConfiguration
        ...
        url = f"{self.BASE_URL}/EV/cmd/chargepoint/getConfiguration"
        payload = {
            "chargepoint": self.CHARGEPOINT_ID,
    ...
    def test_1_10_change_heartbeat(self, auth, headers):
        """
        1.10 ChangeConfiguration
        (HeartbeatInterval: 10 min -> 600s)
        """
        print("\n--- TEST CASE: 1.10 ChangeConfiguration (HeartbeatInterval) ---")
        url = f"{self.BASE_URL}/EV/remote/changeConfiguration"
        payload = {
            "chargepoint_id": self.CHARGEPOINT_ID,
    ...
    def test_1_11_change_meter_sample(self, auth, headers):
        """
    ...
    def test_1_12_change_unlock_connector(self, auth, headers):
        """
    ...
    def test_1_13_change_availability_inoperative(self, evse_simulation):
        """
        1.13 ChangeAvailability (connectorId, Inoperative)
        """
        print("\n--- TEST CASE: 1.13 ChangeAvailability (Inoperative) ---")
        self.inject_csms_command(evse_simulation, "ChangeAvailability", {"connectorId": 1, "type": "Inoperative"})


    # 1.14 StatusNotification (Unavailable)
    def test_1_14_status_unavailable(self):
        """
    ...
    def test_1_15_change_availability_operative(self, evse_simulation):
        """
        1.15 ChangeAvailability (connectorId, Operative)
        """
        print("\n--- TEST CASE: 1.15 ChangeAvailability (Operative) ---")
        self.inject_csms_command(evse_simulation, "ChangeAvailability", {"connectorId": 1, "type": "Operative"})


    # 1.16 StatusNotification (Available)
    def test_1_16_status_available(self):
        """
    ...
    # 1.17 GetDiagnostics
    def test_1_17_get_diagnostics(self, evse_simulation):
        """
        1.17 GetDiagnostics
        """
        print("\n--- TEST CASE: 1.17 GetDiagnostics ---")
        self.inject_csms_command(evse_simulation, "GetDiagnostics", {"location": "ftp://example.com"})


    # 1.18 DiagnosticsStatusNotification
    def test_1_18_diagnostics_status(self):
        """
        1.18 DiagnosticsStatusNotification
        """
    ...
    # 1.19 UpdateFirmware
    def test_1_19_update_firmware(self, evse_simulation):
        """
        1.19 UpdateFirmware
        """
    ...
    def test_1_20_firmware_status(self):
        """
        1.20 FirmwareStatusNotification
        """
    ...
    def test_1_21_change_local_auth(self, auth, headers):
        """
    ...
    # 1.22 SendLocalList
    def test_1_22_send_local_list(self, evse_simulation):
        """
        1.22 SendLocalList
        """
        print("\n--- TEST CASE: 1.22 SendLocalList ---")
        self.inject_csms_command(evse_simulation, "SendLocalList", {"listVersion": 1, "localAuthorizationList": [], "updateType": "Full"})
    ...
    def test_1_23_get_local_list_version(self, evse_simulation):
        """
        1.23 GetLocalListVersion
        """
        print("\n--- TEST CASE: 1.23 GetLocalListVersion ---")
        self.inject_csms_command(evse_simulation, "GetLocalListVersion", {})
    ...
    # 1.24 clearCache
    def test_1_24_clear_cache(self, evse_simulation):
        """
        1.24 clearCache
        """
        print("\n--- TEST CASE: 1.24 clearCache ---")
        self.inject_csms_command(evse_simulation, "ClearCache", {})
