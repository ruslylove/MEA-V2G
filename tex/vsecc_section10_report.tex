...
\textbf{Test Date}         & 2026-06-09 08:49:59 UTC \\
...
\textbf{Summary: 10 PASS \quad 6 FAIL \quad 7 WARN \quad 0 SKIP \quad (23 total)}
...
\hline
\small 10.4 & \small Heartbeat & HTTP 404{\newline\normalfont\footnotesize\itshape Heartbeat endpoint not exposed by MEA sandbox; charger sends heartbeats autonom\ldots{}} & \textcolor{warnorange}{\textbf{WARN}} \\
\hline
...
\hline
\small 10.15 & \small TriggerMessage (StatusNotification) & HTTP 404 — endpoint not exposed by MEA sandbox REST API{\newline\normalfont\footnotesize\itshape TriggerMessage (/remote/triggerMessage) returns HTTP 404} & \textcolor{failred}{\textbf{FAIL}} \\
\hline
\small 10.16 & \small GetConfiguration → Accepted & HTTP 200 status=Bad Request & \textcolor{passgreen}{\textbf{PASS}} \\
\hline
\small 10.17 & \small ChangeConfiguration HeartbeatInterval=600 → Accepted & HTTP 200 & \textcolor{passgreen}{\textbf{PASS}} \\
\hline
\small 10.18 & \small ChangeAvailability (connector 1, Inoperative) & HTTP 404 — endpoint not exposed by MEA sandbox REST API{\newline\normalfont\footnotesize\itshape ChangeAvailability (/remote/changeAvailability) returns HTTP 404} & \textcolor{failred}{\textbf{FAIL}} \\
\hline
...
\hline
\small 10.21 & \small SendLocalList (Full, version=1, idTag=RFID\_TEST) → Accepted & HTTP 404 & \textcolor{failred}{\textbf{FAIL}} \\
\hline
\small 10.22 & \small GetLocalListVersion → Accepted & HTTP 404 & \textcolor{failred}{\textbf{FAIL}} \\
\hline
